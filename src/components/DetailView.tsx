  ...
  return (
    <div className="min-h-svh w-full overflow-y-auto bg-black px-[clamp(1rem,4vw,2rem)] pt-[clamp(1.5rem,5vw,3rem)] pb-16 text-neutral-300">
      <div className="mx-auto max-w-[920px]">
        ...
        <div className="overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-950 shadow-2xl shadow-black/40">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-neutral-800 bg-neutral-900 px-[clamp(1rem,4vw,1.75rem)] py-[clamp(1.25rem,4vw,2rem)]">
            <div className="flex items-center gap-3">
              <LogoMark className="h-[clamp(1.75rem,4vw,2.5rem)] w-[clamp(1.75rem,4vw,2.5rem)] shrink-0 text-[#F6CE71]" />
              <div>
                <p className="font-mono text-[clamp(1.5rem,4vw,2.25rem)] font-bold tracking-wide text-[#E5D0AC]">
                  Karl Abechuela
                </p>
                <p className="mt-1 text-[clamp(0.875rem,2vw,1rem)] text-neutral-500">
                  Software Engineer, AI &amp; Automation
                </p>
              </div>
            </div>
            <p className="whitespace-nowrap text-sm uppercase tracking-[0.1em] text-[#F6CE71]">
              Ship first, panic never.
            </p>
          </div>

          <div className="flex flex-wrap gap-4 border-b border-neutral-800 px-[clamp(1rem,4vw,1.75rem)] py-4 text-sm text-neutral-500">
